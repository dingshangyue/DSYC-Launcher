...
#[tauri::command]
pub fn retrieve_memory_info() -> DSYCLauncherResult<MemoryInfo> {
  Ok(get_memory_info())
}

#[tauri::command]
pub fn extract_filename(path_str: String, with_ext: bool) -> DSYCLauncherResult<String> {
  Ok(extract_filename_helper(&path_str, with_ext))
}

#[tauri::command]
pub fn delete_file(path: String) -> DSYCLauncherResult<()> {
  fs::remove_file(&path).map_err(Into::into)
}

#[tauri::command]
pub fn delete_directory(path: String) -> DSYCLauncherResult<()> {
  fs::remove_dir_all(&path).map_err(Into::into)
}

#[tauri::command]
pub fn retrieve_truetype_font_list() -> DSYCLauncherResult<Vec<String>> {
