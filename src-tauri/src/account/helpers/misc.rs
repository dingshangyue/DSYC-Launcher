...
pub async fn fetch_image(app: &AppHandle, url: String) -> DSYCLauncherResult<ImageWrapper> {
...
pub fn get_selected_player_info(app: &AppHandle) -> DSYCLauncherResult<PlayerInfo> {
...
pub async fn check_full_login_availability(app: &AppHandle) -> DSYCLauncherResult<()> {
...
) -> DSYCLauncherResult<OAuthTokens> {
  let account_binding = app.state::<Mutex<AccountInfo>>();
  {
