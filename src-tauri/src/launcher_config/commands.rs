use crate::error::DSYCLauncherError;
...
#[tauri::command]
pub fn retrieve_launcher_config(app: AppHandle) -> DSYCLauncherResult<LauncherConfig> {
...
#[tauri::command]
pub fn restore_launcher_config(app: AppHandle) -> DSYCLauncherResult<LauncherConfig> {
...
pub async fn import_launcher_config(
  ...
  client: tauri::State<'_, reqwest::Client>,
  code: String,
) -> DSYCLauncherResult<LauncherConfig> {
  match client
...
#[tauri::command]
pub fn reveal_launcher_config() -> DSYCLauncherResult<()> {
  let file_path = LauncherConfig::file_path();
  reveal_item_in_dir(file_path).map_err(DSYCLauncherError::from)
}

#[tauri::command]
pub fn retrieve_custom_background_list(app: AppHandle) -> DSYCLauncherResult<Vec<String>> {
...
#[tauri::command]
pub fn add_custom_background(app: AppHandle, source_src: String) -> DSYCLauncherResult<String> {
...
#[tauri::command]
pub fn delete_custom_background(app: AppHandle, file_name: String) -> DSYCLauncherResult<()> {
  let custom_bg_dir = app
    .path()
    .resolve::<PathBuf>("UserContent/Backgrounds".into(), BaseDirectory::AppData)?;
...
#[tauri::command]
pub async fn retrieve_java_list(app: AppHandle) -> DSYCLauncherResult<Vec<JavaInfo>> {
...
#[tauri::command]
pub async fn validate_java(java_path: String) -> DSYCLauncherResult<()> {
...
#[tauri::command]
pub async fn download_mojang_java(app: AppHandle, version: String) -> DSYCLauncherResult<()> {
...
#[tauri::command]
pub async fn check_game_directory(app: AppHandle, dir: String) -> DSYCLauncherResult<String> {
...
#[tauri::command]
pub async fn clear_download_cache(app: AppHandle) -> DSYCLauncherResult<()> {
...
#[tauri::command]
pub async fn check_launcher_update(app: AppHandle) -> DSYCLauncherResult<VersionMetaInfo> {
  let config_binding = app.state::<Mutex<LauncherConfig>>();
  let current_version = {
