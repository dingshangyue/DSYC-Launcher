...
#[tauri::command]
pub async fn open_game_log_window(app: AppHandle, launching_id: u64) -> DSYCLauncherResult<()> {
...
#[tauri::command]
pub fn retrieve_game_log(app: AppHandle, launching_id: u64) -> DSYCLauncherResult<Vec<String>> {
...
pub fn retrieve_game_launching_state(
  launching_queue_state: State<'_, Mutex<Vec<LaunchingState>>>,
  launching_id: u64,
) -> DSYCLauncherResult<LaunchingState> {
