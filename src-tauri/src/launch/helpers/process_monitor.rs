...
pub fn kill_process(pid: u32) -> DSYCLauncherResult<()> {
...
pub fn set_process_priority(pid: u32, priority: &ProcessPriority) -> DSYCLauncherResult<()> {
...
pub fn change_process_window_title(pid: u32, new_title: &str) -> DSYCLauncherResult<()> {
