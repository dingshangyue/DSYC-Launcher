...
#[tauri::command]
pub fn retrieve_player_list(app: AppHandle) -> DSYCLauncherResult<Vec<Player>> {
...
) -> DSYCLauncherResult<DeviceAuthResponseInfo> {
...
#[tauri::command]
pub fn cancel_oauth(app: AppHandle) -> DSYCLauncherResult<()> {
  let account_binding = app.state::<Mutex<AccountInfo>>();
  let mut account_state = account_binding.lock()?;
...
#[tauri::command]
pub async fn add_player_from_selection(app: AppHandle, player: Player) -> DSYCLauncherResult<()> {
...
#[tauri::command]
pub async fn delete_player(app: AppHandle, player_id: String) -> DSYCLauncherResult<()> {
  {
    let account_binding = app.state::<Mutex<AccountInfo>>();
    let mut account_state = account_binding.lock()?;
...
#[tauri::command]
pub async fn refresh_player(app: AppHandle, player_id: String) -> DSYCLauncherResult<()> {
  let account_binding = app.state::<Mutex<AccountInfo>>();
...
#[tauri::command]
pub fn retrieve_auth_server_list(app: AppHandle) -> DSYCLauncherResult<Vec<AuthServer>> {
...
#[tauri::command]
pub async fn fetch_auth_server(app: AppHandle, url: String) -> DSYCLauncherResult<AuthServer> {
...
#[tauri::command]
pub async fn add_auth_server(app: AppHandle, auth_url: String) -> DSYCLauncherResult<()> {
  if get_auth_server_info_by_url(&app, auth_url.clone()).is_ok() {
    return Err(AccountError::Duplicate.into());
  }
...
#[tauri::command]
pub fn delete_auth_server(app: AppHandle, url: String) -> DSYCLauncherResult<()> {
  let account_binding = app.state::<Mutex<AccountInfo>>();
  let mut account_state = account_binding.lock()?;
...
) -> DSYCLauncherResult<(Vec<Player>, Vec<AuthServer>)> {
