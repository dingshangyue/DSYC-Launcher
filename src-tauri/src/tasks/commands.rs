...
pub async fn schedule_progressive_task_group(
  ...
  with_timestamp: bool,
) -> DSYCLauncherResult<PTaskGroupDesc> {
  ...
  for param in params {
    ...
    match param {
      PTaskParam::Download(mut param) => {
        ...
        let future_desc = DSYCLauncherFutureDesc {
          task_id,
          f: Box::pin(f),
          h: h.clone(),
        };
...
#[tauri::command]
pub fn create_transient_task(app: AppHandle, desc: THandle) -> DSYCLauncherResult<()> {
  let monitor = app.state::<Pin<Box<TaskMonitor>>>();
...
#[tauri::command]
pub fn cancel_transient_task(app: AppHandle, task_id: u32) -> DSYCLauncherResult<()> {
  let monitor = app.state::<Pin<Box<TaskMonitor>>>();
...
#[tauri::command]
pub fn get_transient_task(app: AppHandle, task_id: u32) -> DSYCLauncherResult<Option<THandle>> {
  let monitor = app.state::<Pin<Box<TaskMonitor>>>();
  Ok(monitor.get_transient_task(task_id))
}

#[tauri::command]
pub fn cancel_progressive_task(app: AppHandle, task_id: u32) -> DSYCLauncherResult<()> {
  let monitor = app.state::<Pin<Box<TaskMonitor>>>();
...
#[tauri::command]
pub fn resume_progressive_task(app: AppHandle, task_id: u32) -> DSYCLauncherResult<()> {
  let monitor = app.state::<Pin<Box<TaskMonitor>>>();
...
#[tauri::command]
pub async fn restart_progressive_task(app: AppHandle, task_id: u32) -> DSYCLauncherResult<()> {
  let monitor = app.state::<Pin<Box<TaskMonitor>>>();
...
#[tauri::command]
pub fn stop_progressive_task(app: AppHandle, task_id: u32) -> DSYCLauncherResult<()> {
  let monitor = app.state::<Pin<Box<TaskMonitor>>>();
...
#[tauri::command]
pub fn cancel_progressive_task_group(app: AppHandle, task_group: String) -> DSYCLauncherResult<()> {
  let monitor = app.state::<Pin<Box<TaskMonitor>>>();
...
#[tauri::command]
pub fn stop_progressive_task_group(app: AppHandle, task_group: String) -> DSYCLauncherResult<()> {
  let monitor = app.state::<Pin<Box<TaskMonitor>>>();
