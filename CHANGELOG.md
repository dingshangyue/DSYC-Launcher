...
DSYCLauncher follows [Semantic Versioning 2.0.0](http://semver.org/).
...
- 🐛 Fix the issue where Mojang Java runtime downloaded by DSYCLauncher on macOS lacked execution permissions. #1154 @UNIkeEN  
...
- Workflow:
   - Auto upload release artifacts to the DSYC server. #880 @Minecrafter-Pythoner @hans362
