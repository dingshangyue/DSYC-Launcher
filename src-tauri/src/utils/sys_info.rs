...
/// Sends app version, OS type and self SHA-256 as statistic data to DSYC asynchronously.
///
/// # Examples
///
/// ```rust
...
/// ```
pub fn find_free_port(start_port: Option<u16>) -> DSYCLauncherResult<u16> {
  ...
  Err(DSYCLauncherError("No free port found".to_string()))
}
