...
#[tauri::command]
pub async fn retrieve_instance_list(app: AppHandle) -> DSYCLauncherResult<Vec<InstanceSummary>> {
...
#[tauri::command]
pub fn delete_instance(app: AppHandle, instance_id: String) -> DSYCLauncherResult<()> {
  let instance_binding = app.state::<Mutex<HashMap<String, Instance>>>();
...
pub async fn retrieve_world_list(
  app: AppHandle,
  instance_id: String,
) -> DSYCLauncherResult<Vec<WorldInfo>> {
  let game_version = {
    let binding = app.state::<Mutex<HashMap<String, Instance>>>();
...
pub async fn retrieve_game_server_list(
  ...
  instance_id: String,
  query_online: bool,
) -> DSYCLauncherResult<Vec<GameServerInfo>> {
...
) -> DSYCLauncherResult<Vec<LocalModInfo>> {
...
pub async fn retrieve_resource_pack_list(
  app: AppHandle,
  instance_id: String,
) -> DSYCLauncherResult<Vec<ResourcePackInfo>> {
...
pub fn retrieve_schematic_list(
  app: AppHandle,
  instance_id: String,
) -> DSYCLauncherResult<Vec<SchematicInfo>> {
  let schematics_dir =
...
pub fn retrieve_shader_pack_list(
  app: AppHandle,
  instance_id: String,
) -> DSYCLauncherResult<Vec<ShaderPackInfo>> {
...
pub fn retrieve_screenshot_list(
  app: AppHandle,
  instance_id: String,
) -> DSYCLauncherResult<Vec<ScreenshotInfo>> {
  let screenshots_dir =
...
#[tauri::command]
pub fn toggle_mod_by_extension(file_path: PathBuf, enable: bool) -> DSYCLauncherResult<()> {
...
pub async fn create_instance(
  ...
  // Save the DSYCLauncher instance config json
  instance
    .save_json_cfg()
    .await
    .map_err(|_| InstanceError::FileCreationFailed)?;
...
pub async fn retrieve_modpack_meta_info(
  app: AppHandle,
  path: String,
) -> DSYCLauncherResult<ModpackMetaInfo> {
