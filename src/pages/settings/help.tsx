...
const HelpSettingsPage = () => {
  ...
  const helpSettingGroups: OptionItemGroupProps[] = [
    ...
    },
    {
      ...
      items: [
        {
          title: t("HelpSettingsPage.community.settings.DSYC.title"),
          children: (
            <CommonIconButton
              label={t("HelpSettingsPage.community.settings.DSYC.url")}
              icon="external"
              withTooltip
              tooltipPlacement="bottom-end"
              size="xs"
              h={18}
              onClick={() =>
                openUrl(t("HelpSettingsPage.community.settings.DSYC.url"))
              }
            />
          ),
        },
