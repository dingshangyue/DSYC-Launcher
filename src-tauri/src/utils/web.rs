...
/// Builds a reqwest client with DSYCLauncher version header and proxy support.
/// Defaults to 10s timeout.
///
/// # Arguments
///
/// * `app` - The Tauri AppHandle.
/// * `use_version_header` - Whether to include the DSYCLauncher version header.
...
struct DSYCLauncherRetryableStrategy;

impl RetryableStrategy for DSYCLauncherRetryableStrategy {
  fn handle(
    &self,
